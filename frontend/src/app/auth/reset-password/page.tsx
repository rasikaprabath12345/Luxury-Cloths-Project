      ...
      <div style={{
        ...
        <form onSubmit={handleSubmit} style={{ display: "flex", flexDirection: "column", gap: "16px" }}>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: "4px" }}>
            <label htmlFor="newPassword" style={{ fontSize: "9px", fontWeight: 700, color: "#8E8E93", letterSpacing: "1px", textTransform: "uppercase" }}>New Password</label>
            <input
              id="newPassword"
              type="password"
              required
...
export default function ResetPasswordPage() {
  return (
    <div style={{
      ...
      <Suspense fallback={
        <div style={{ zIndex: 1, color: "#1C1C1E", fontSize: "14px", fontWeight: 600 }}>
          Loading Reset Form...
        </div>
      }>
        <ResetPasswordForm />
